                ...
                <Container fluid>
                    <Row className="g-4">
                        {produtos.map((produto) => {
                            console.log(produto)
                            const imagemPrincipal = produto.imagens.find(img => img.principal == true) || 'https://via.placeholder.com/150'

                            return (
                                <Col key={produto.id} lg={2} md={4} sm={6} xs={12} className="suave-transition">
                                    <Card className="h-100 shadow-sm">
                                        <Card.Img variant="top" src={"http://localhost:8080" + imagemPrincipal.url ?? 'https://via.placeholder.com/150'} />
                                        <Card.Body>
